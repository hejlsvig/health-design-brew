...
### Edge Functions
Deployes manuelt via Supabase CLI:
```bash
...
Køres manuelt i Supabase SQL Editor (rækkefølge: 001 → 010).
Alle migrations er idempotente (`IF NOT EXISTS`, `ON CONFLICT DO NOTHING`).
