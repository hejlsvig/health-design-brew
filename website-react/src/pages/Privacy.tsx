          ...
          <div className="container py-16">
            <div className="max-w-2xl mx-auto text-center space-y-4">
              <p className="text-muted-foreground leading-relaxed">
                {t('privacyPage.placeholder', 'We are preparing our privacy policy. Please check back soon.')}
              </p>
              <p className="text-sm text-muted-foreground">
                {t('privacyPage.gdprNotice', 'Shifting Source is committed to protecting your personal data in accordance with GDPR and other applicable privacy laws.')}
              </p>
            </div>
          </div>
        </section>
