...
import {
  ...
  LayoutDashboard, HelpCircle, Type, Megaphone, X,
...
const NEW_SECTION_TYPES = ['content_block', 'faq', 'cta_banner']
    ...
    <div className="container py-8 max-w-3xl">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-serif text-2xl font-bold text-primary">{t('admin.privacyEditorTitle')}</h1>
        </div>
        <button
          onClick={handleSave}
      ...
      <p className="text-sm text-muted-foreground mb-6">
        {t('admin.privacyEditorDescription')}
      </p>
